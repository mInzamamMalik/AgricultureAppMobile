...
angular.module('starter', ['ionic', 'signup', 'login', 'dashboard', 'addZameen','zameenDetail','addEvent'])
    ...
    .config(function ($urlRouterProvider, $stateProvider, $httpProvider) {
        $stateProvider
            ...
            .state("zameenDetail", {
                url: "/zameenDetail",
                templateUrl: "views/zameenDetail/zameenDetail.html",
                controller: "zameenDetailController"
            })
            .state("addEvent", {
                url: "/addEvent",
